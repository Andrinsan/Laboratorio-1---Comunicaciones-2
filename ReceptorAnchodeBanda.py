...
class ReceptorAnchodeBanda(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("GNU Radio", "ReceptorAnchodeBanda")
...
def main(top_block_cls=ReceptorAnchodeBanda, options=None):
