...
# Title: Practica Ancho de Banda
# Author: Subgrupo04_J1B
...
class Practica1_labComu2_GJ1B_04(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "Practica Ancho de Banda", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("Practica Ancho de Banda")
        ...
        self.settings = Qt.QSettings("GNU Radio", "Practica1_labComu2_GJ1B_04")
        ...
        self.analog_sig_source_x_0 = analog.sig_source_c(samp_rate, analog.GR_COS_WAVE, samp_rate, 1, 0, 0)
...
def main(top_block_cls=Practica1_labComu2_GJ1B_04, options=None):
